...
$('.iqdropdown-buttons__clear').on('click', function(itemCount, totalItems) {
    var counters = $('.iqdropdown-guest').find('.counter');
    $.each(($('.iqdropdown-guest').find('.counter')), function(key, itemCount) {
      $(itemCount).val(0);
    });

    $('.iqdropdown-guest').find('.iqdropdown-selection').text('Сколько гостей');
    $('.iqdropdown-guest').find('.counter').val(0);
    $('.iqdropdown-guest').find('.counter').text('0');
    itemCount.guest1 = 0;
    totalItems = 0;
    console.log('totalItems: ' + totalItems); // totalItems: 0
    console.log('itemCount: ' + itemCount.guest1); // totalItems: 0
  
  });

$('.iqdropdown-buttons__clear').on('click', function(itemCount, totalItems) {
    var counters = $('.iqdropdown').find('.counter');
    $.each(($('.iqdropdown').find('.counter')), function(key, itemCount) {
      $(itemCount).val(0);
    });

    $('.iqdropdown').find('.iqdropdown-selection').text('Сколько гостей');
    $('.iqdropdown').find('.counter').val(0);
    itemCount.guest1 = 0;
    totalItems = 0;
    console.log('totalItems: ' + totalItems); // totalItems: 0
    console.log('itemCount: ' + itemCount.guest1); // totalItems: 0
